...
class windows1:
    def __init__(self, master):
        ...
        self.button_Dr_appt = Button(self.LoginFrame3, text="Doctor Appointment Window", state = DISABLED, font=("arial", 15, "bold"), 
        ...
        self.textPassword = Entry(self.LoginFrame1, font=("arial", 20, "bold"), bd=3, textvariable = self.Password, show="*")
